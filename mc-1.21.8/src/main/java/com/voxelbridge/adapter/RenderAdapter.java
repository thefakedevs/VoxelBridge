...
public interface RenderAdapter {
     ...
     */
    BlockStateModel getBlockModel(BlockState state);
     ...
     */
    List<BakedQuad> getQuads(BlockStateModel model, BlockState state, BlockPos pos, BlockAndTintGetter level, long seed);
